                                ...
                                <div class="content ">
                                    ...
                                    <div class="content__item">
                                        <div class="content__item-intro">
                                            <img class="content__item-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/1.jpg" alt="Some image"/>
                                ...
                                <div class="grid">
                                    <a href="#" class="grid__item" style="grid-area: 1 / 2 / 4 / 7;">
                                        ...
                                        <div class="grid__item-wrap">
                                            <img class="grid__item-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/1.jpg" alt="Some image"/>
                                        </div>
                                        <h3 class="grid__item-title text-warning"><?php _e( 'Tour of my Life', 'blog' ); ?></h3>
                                        <h4 class="grid__item-number text-light"><?php the_title(); ?></h4>
                                    </a>
                                    <a href="#" class="grid__item" style="grid-area:1 / 4 / 4 / 6;">
                                        <div class="grid__item-bg"></div>
                                        <div class="grid__item-wrap">
                                            <img class="grid__item-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/2.jpg" alt="Some image"/>
                                        </div>
                                        <h3 class="grid__item-title text-warning"><?php _e( 'One day in Africa', 'blog' ); ?></h3>
                                        <h4 class="grid__item-number text-light"><?php _e( 'A21', 'blog' ); ?></h4>
                                    </a>
                                    <a href="#" class="grid__item" style="grid-area:4 / 2 / 7 / 3;">
                                        <div class="grid__item-bg"></div>
                                        <div class="grid__item-wrap">
                                            <img class="grid__item-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/10.jpg" alt="Some image"/>
                                        </div>
                                        <h3 class="grid__item-title text-warning"><?php _e( 'Holding your breath', 'blog' ); ?></h3>
                                        <h4 class="grid__item-number text-light"><?php _e( 'OP2', 'blog' ); ?></h4>
                                    </a>
                                    <a href="#" class="grid__item" style="grid-area:4 / 4 / 7 / 5;">
                                        <div class="grid__item-bg"></div>
                                        <div class="grid__item-wrap">
                                            <img class="grid__item-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/9.jpg" alt="Some image"/>
                                        </div>
                                        <h3 class="grid__item-title text-warning"><?php _e( 'Loosing my mind', 'blog' ); ?></h3>
                                        <h4 class="grid__item-number text-light"><?php _e( 'UY6', 'blog' ); ?></h4>
                                    </a>
                                </div>
                                <div class="grid-wrap col-md-12">
</div>
                                <!-- /grid-wrap -->
                            </main>
                        </div>                         
